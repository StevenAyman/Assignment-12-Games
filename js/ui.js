...
// Constructor Function responsible for display any data
export default function UI() {
  // Function to display game cards in html
  this.displayGames = function (gamesArray) {
    let cartona = "";
  ...
  this.displayGameInfo = function (game) {
    ...
    document.querySelector(".game-details .game-title").innerHTML =
      gameInfo.name;
